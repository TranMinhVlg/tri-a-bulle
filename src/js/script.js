...
{ 
  for (var j = 0; j < i; j++) //parcours du tab de la gauche vers la droite avec un autre indice j
  { 
    if (tab[j] > tab[j+1]) // si la valeur contenue dans tab[j] inférieure à tab[i]
    { 
